...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("zone-name-filter", "Filter target zones by zone domain when running on AzureDNS; specify multiple times for multiple zones (optional)").Default("").StringsVar(&cfg.ZoneNameFilter)
